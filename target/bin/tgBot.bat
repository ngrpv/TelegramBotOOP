...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="tgBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" first.Main %CMD_LINE_ARGS%
